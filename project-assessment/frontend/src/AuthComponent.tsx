            ...
            <div className="bg-white overflow-auto max-w-lg max-h-[90vh]">
              ...
              <div className="p-8 pt-4">
                ...
                <button
                  ...
                  disabled={loading}
                  className="w-full mb-6 px-4 py-3 border border-gray-300 rounded-lg hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-3"
                >
